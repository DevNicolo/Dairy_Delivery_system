...
class ResCompany(models.Model):
    ...
    package_field_ids = fields.Many2many('ir.model.fields','package_fields_company_rel', 'package_id', 'company_id', string='Package Fields', help="Fields configuration for Package QR Code generation")
